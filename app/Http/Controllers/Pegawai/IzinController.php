...
Tanggal : " . $data['tanggal'];
    ...
    {
        if (request('komen')) $izin->komen = request('komen');
        if (request('status')) $izin->status = request('status');
        if (request('perihal')) $izin->perihal = request('perihal');
        if (request('pangkat')) $izin->pangkat = request('pangkat');
        if (request('alasan')) $izin->alasan = request('alasan');
        if (request('waktu')) $izin->waktu = request('waktu');
        if (request('selama')) $izin->selama = request('selama');
        $izin->save();
