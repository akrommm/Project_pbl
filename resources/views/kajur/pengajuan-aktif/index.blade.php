            ...
            <table id="data-table" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="{{ url('kajur/pengajuan-aktif', $izin->id) }}" class="btn btn-primary btn-tone"><i class="fa fa-eye"> Detail</i></a>
                            </div>
                        </td>
                    </tr>
                    @endif
            ...
            <table id="data-table" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="{{ url('kajur/pengajuan-aktif1', $sakit->id) }}" class="btn btn-primary btn-tone"><i class="fa fa-eye"> Detail</i></a>
                            </div>
                        </td>
                    </tr>
                    @endif
