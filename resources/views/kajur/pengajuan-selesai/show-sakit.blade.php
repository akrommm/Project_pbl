<x-module.kajur>
    <div class="card-header py-2">
        <h5 class="m-0 font-weight-bold text-dark" style="text-align:center; font-size: 25px"> DETAIL PENGAJUAN IZIN SAKIT
        </h5>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            @if ($sakit->status == 3)
            <a href="{{ url('kajur/cetak_sakit/word-export3', $sakit->id) }}" target="_blank" class="text-white btn btn-block btn-dark fas fa-download col-md-2">
                <span> Download Dokumen</span>
            </a>
            @endif
            <hr>
