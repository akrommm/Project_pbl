<x-module.admin>
    <div class="card-header py-2">
        <h5 class="m-0 font-weight-bold text-dark" style="text-align:center; font-size: 25px"> EDIT UNIT KERJA
        </h5>
    </div>
    <br>
    <x-template.button.back-button url="admin/master-data/unitkerja" />
    <div class="card">
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @endif
                            <input type="text" name="nama_unit" value="{{ $unitkerja->nama_unit }}" class=" form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
