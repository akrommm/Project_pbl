<x-module.pegawai>
    <div class="card-header">
        <h5 class="m-0 font-weight-bold text-dark" style="text-align:center; font-size: 25px"> EDIT PENGAJUAN IZIN
        </h5>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('pegawai/izin', $izin->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" class="form-control  @error('pangkat') is-invalid @enderror" name="pangkat" value="{{ $izin->pangkat }}">
                                </div>
                            </div>
                        </div>
                        <div class="mt-3 mb-3">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <select name="perihal" class="form-control">
                                        <option disabled selected>{{ $izin->perihal }}</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" class="form-control  @error('selama') is-invalid @enderror" name="selama" placeholder="....../jam/menit*" value="{{$izin->selama}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <div class="d-flex align-items-center">
                                        <input type="text" class="form-control datepicker-input" name="waktu" placeholder="Pada Hari" value="{{ $izin->waktu }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <textarea name="alasan" id="" cols="20" rows="3" class="form-control @error('alasan') is-invalid @enderror">{{ $izin->alasan }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
