<x-module.pegawai>
    <div class="card-header py-2">
        <h5 class="m-0 font-weight-bold text-dark" style="text-align:center; font-size: 25px"> TAMBAH PENGAJUAN IZIN SAKIT
        </h5>
    </div>
    <br>
    <div class="row">
        <div class="col-md-12">
            <a href="{{ url('pegawai/sakit') }}" class="btn btn-primary btn-tone btn-sm mt-4"><i class="fas fa-arrow-left"> Kembali</i></a>
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('pegawai/sakit') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <h3 class="text-center">FORMULIR PENGAJUAN IZIN SAKIT POLITAP</h3>
                        <hr>
                        <div class="row">
                            <div class="col-md-3">
                        ...
                        <div class="mt-3 mb-3">
                            <strong class="mt-3">Dengan ini mengajukan pengajuan sakit tidak masuk kerja dengan rincian sebagai berikut:</strong>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <label for="" class="control-label mt-3">SURAT KETERANGAN DOKTER</label>
                            </div>
                            <div class="col-md-9">
                                <input type="file" name="lampiran" accept=".jpg, .png, .jpeg" class="form-control mb-3">
                                <p>*Lampirkan surat keterangan dokter apa bila sakit lebih dari 1 hari</p>
                            </div>
                        </div>
                        <br>
                        <div class="row">
