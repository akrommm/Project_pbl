                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        ...
                        <div class="m-l-15">
                            ...
                            <p class="m-b-0 text-muted">Pengajuan Izin</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        ...
                        <div class="m-l-15">
                            ...
                            <p class="m-b-0 text-muted">Pengajuan Izin Cuti</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="media align-items-center">
                        ...
                        <div class="m-l-15">
                            <h2 class="m-b-0">{{$dinas}}</h2>
                            <p class="m-b-0 text-muted">Pengajuan Izin Dinas Luar</p>
                        </div>
                    </div>
                </div>
            </div>
